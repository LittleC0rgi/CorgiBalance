...
import com.corgibalance.components.views.OverviewView.NearestPayment;
...
public class NearestPaymentsTest {
    ...
    public void upcomingSortedByDateLimitedToFive() {
        ...
        List<NearestPayment> result = OverviewView.nearestPayments(planned, recurring, today, 5);
    ...
    public void emptyWhenNothingDue() {
        LocalDate today = LocalDate.of(2026, 8, 20);
        List<NearestPayment> result = OverviewView.nearestPayments(List.of(), List.of(), today, 5);
